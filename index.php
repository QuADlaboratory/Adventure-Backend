...
// TODO: Have it handing checking the ID for log in
// or this one could also handle it or be tweaked to have it branch for login
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        // checking if the resquest is sending a JSON
        if($_SERVER['CONTENT_TYPE'] == 'application/json; charset=UTF-8'){

        // list of the col in the data base that could be null
